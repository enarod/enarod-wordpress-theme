...
<div class="one_fourth">
	<div class="text-2"><input type="button" value="Назад" class="button_green" onclick="location.href='/../agreements-major/'">
		</div></div>
<!--<div class="one_fourth">
	<div class="text-2">		
...
<script>
	...
	//var agreementID = <?php echo $id ?>;
	console.log('2: ' + agreementID);

	/*
	var service = new AgreementService();
	service.getAgreement(agreementID , function (data) {
		$('#agreement-name').html('<div>' + data.Name + '</div>');
