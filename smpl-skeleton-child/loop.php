...
<?php /* How to display all other posts. */ ?>
	...
	<?php if ( is_archive() || is_search() ) : // Only display excerpts for archives and search. ?>
            <div class="entry-summary">
                <?php echo get_the_post_thumbnail( $post->ID, array(200, 200), $attr ); ?> <?php the_excerpt(); ?>
			</div><!-- .entry-summary -->
	<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'smpl' ) ); ?>
			...
			<div class="entry-utility">
				...
				?>
					<span class="tag-links">
						<?php printf( __( '<span class="%1$s"></span> %2$s', 'smpl' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
					</span>
					<span class="meta-sep">|</span>
				<?php endif; ?>
				<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'smpl' ), __( '1 Comment', 'smpl' ), __( '% Comments', 'smpl' ) ); ?></span>
