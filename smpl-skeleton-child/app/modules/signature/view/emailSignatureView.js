	...
	function(require){
		...
		return Backbone.View.extend({
			...
			render: function(){
				...
				this.stickit( this.model.get('Signator') );
				return this;
			},

			signWithEmail: function(){
				this.setModelParameters (this.model.get('Signator') );
				Backbone.Validation.bind ( this, {
					model	: this.model.get('Signator'),
				...
				if ( this.model.get('Signator').isValid(true) ){
					this.model.save();
				}
			},	
