var AgreemnetService = function () {
	var agreementServiceUrl = 'http://185.9.41.142/api/agreement/';
	var cryptoServiceUrl = 'http://185.9.41.142/api/crypto/';
	var participantServiceUrl = 'http://185.9.41.142/api/user';
